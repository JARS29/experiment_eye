...
def saccade_detection(x, y, time, missing=0.0, minlen=20, maxvel=1385, maxacc=369459):
    #min len > 2* 1/ts (nyquist)
    # max vel 30degree/seg maxacc 8000 degree/seg**2 https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3048294/
