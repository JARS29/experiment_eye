...
def writing_data(data, subject, condition, type): ###
    ...
    if type == 0:
        ...
        with open('time_data_' + subject + ' ' + condition + '.csv', 'w') as newFile:
...
#writing_data(times, '005','vs', 0)
#writing_data(eye_data,'004','vs',1)
visualization_eye(eye_data, '006', 'vs', 99, 1)
